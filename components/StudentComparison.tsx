  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div className="space-y-2">
            {students.map((student) => (
              <div key={student.profile.id} className="flex items-center gap-3">
                <span className="text-xs text-[#9CA3AF] w-20 truncate">
        ...
        {/* Weekly Practice Time — second */}
        <div className="bg-[#181B22] border border-white/[0.06] rounded-lg p-4">
          <div className="flex items-center gap-2 mb-3">
            <span className="text-sm font-medium text-[#9CA3AF]">⏱️ Time This Week</span>
          </div>
          <div className="space-y-2">
            {students.map((student) => {
