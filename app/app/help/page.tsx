      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-[#B0B8C4] pl-2">
            <p>
              <strong className="text-[#F5F7FA]">Add a song</strong> — Tap the <em>Add Song</em> button on the Library tab. Enter the title, artist (optional), and a color dot to identify it.
            </p>
            <p>
            ...
            <p>
              <strong className="text-[#F5F7FA]">Remove a song</strong> — Open the song&apos;s settings and tap <em>Delete Song</em>.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-[#B0B8C4] pl-2">
            <p>
              <strong className="text-[#F5F7FA]">Start practicing</strong> — Tap any song card to select it, then tap <em>Start Practice</em> on the timer. Or tap the <em>Start Practice</em> button directly on the song card — this starts the timer automatically.
            </p>
            <p>
              <strong className="text-[#F5F7FA]">Pause &amp; resume</strong> — Tap <em>Pause</em> to take a break. Tap <em>Resume</em> when you&apos;re ready to continue.
            </p>
            <p>
              <strong className="text-[#F5F7FA]">Stop &amp; save</strong> — Tap <em>Stop &amp; Save</em> to end your session. Your time is recorded automatically.
            </p>
            <p>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-[#B0B8C4] pl-2">
            <p>
              <strong className="text-[#F5F7FA]">Connect with a teacher</strong> — Tap <em>Share</em> in the header to enter your teacher&apos;s email. They&apos;ll receive an invitation.
            </p>
            <p>
            ...
            <p>
              <strong className="text-[#F5F7FA]">Assignments</strong> — Your teacher can assign pieces for you to practice. Assignments appear in the <em>Assignments</em> tab. Tap an assignment to add it to your library.
            </p>
          </div>
        </section>
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3 text-[#B0B8C4] pl-2">
            <p>
              <strong className="text-[#F5F7FA]">View assignments</strong> — Tap the <em>Assignments</em> tab to see pieces your teacher has assigned.
            </p>
            <p>
              <strong className="text-[#F5F7FA]">Add to library</strong> — Tap <em>Add to Library</em> on an assignment to create a song card for it. Then practice it like any other song.
            </p>
            <p>
